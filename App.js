...
nextBtn.addEventListener('click', ()=>{
    ...
    if(Number(billAmt.value)>0){
        ...
        showError("Enter your bill amount");
    }
} )
...
checkBtn.addEventListener('click', ()=>{
    ...
    if(billAmtValue > cashRecievedValue){
      showError("Seems like you don't have enough cash");
      return;
    }
  
    calculateNotes(billAmtValue, cashRecievedValue);
  } else {
      showError("Enter valid amount in both the fields to continue");
    }
})
